...
const Profile1 = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Fetch user profile
        const userRes = await axios.get(`http://localhost:3000/api/userProfile/${userId}`);
    ...
    <>
      ...
      <div className="profile-container">
        <div className="user-info">
          <img
            src="https://media.licdn.com/dms/image/v2/C4E1BAQH1tZKM2piEnQ/company-background_10000/company-background_10000/0/1615372131196/devstream_cover?e=2147483647&v=beta&t=YzErqGf2JQIs4KBEZ97eyx3nekdoHxnxeCMCiJ30YQY"
            alt="User Avatar"
            className="avatar"
          />
